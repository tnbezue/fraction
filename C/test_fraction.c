...
void test_fraction_set()
{
  ...
  int64_t set_test_data[][4]={ { 0,1,0,1 }, {1,1,1,1}, {-2,3,-2,3}, {2,-3,-2,3},
    {-2,-3,2,3}, { 17179869183,68719476736, 536870912,2147483647}, { 68719476736,17179869183,2147483647,536870912 }
